"""
Logging configuration for the corset-tools package.
...
def init_logging(
    ...
    if logfile:
        try:
            ...
            logging.debug(f'Logging initialized with level: {loglevel}')
            logging.debug(f'Log file: {logfile_path.absolute()}')
